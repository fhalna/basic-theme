...
declare class TweenMax extends TweenLite {
	...
	static staggerFromTo( targets:JQuery, duration:number, fromVars:Object, toVars:Object, stagger:number, onCompleteAll?:Function, onCompleteAllParams?:any[], onCompleteAllScope?:any ):any[];
...
interface ThrowPropsPlugin {
	defaultResistance:number;
	track(object:any, prop:any);
	untrack(object:any);
	to(...args: any[]);
}

interface Draggable {
	create( element:string, opts:any );
	create( element:HTMLElement, opts:any );
}
...
declare var Draggable:Draggable;
declare var ThrowPropsPlugin:ThrowPropsPlugin;
